...
public class loassign1 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("UPDATE shows set comment=? where year=?");

            ps.setString(1, comnt);
            ps.setString(2, yr);
            ps.executeUpdate();
            sql = "SELECT * FROM shows;";
            // UPDATE shows SET comment = " + comnt + " WHERE year = " + yr + ";+ "'" +
            // comnt + "'" + "WHERE year = " + "'" + yr + "'" + ";"
            ...
            out.println("<br><br><button id='render-btn' type='submit' onclick='window.open('movies')'>BACK</button>");
